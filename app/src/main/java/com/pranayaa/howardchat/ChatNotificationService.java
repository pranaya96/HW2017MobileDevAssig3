...
public class ChatNotificationService extends Service{
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Log.i("PA-SERVICE", "service started");
        setupDatabase();
    ...
    public void onDestroy() {
        super.onDestroy();
        Log.i("PA-SERVICE", "service stopped");
    }
    ...
    private void setupDatabase() {
        ...
        lastMessageQuery.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Log.i("PA-SERVICE", "Received message change:" + message.getUserName());
                FirebaseUser user = FirebaseAuth.getInstance().getCurrentUser();
                if(!(message.getUserName().equals(user.getDisplayName()))){
    ...
    private void showNotification(Message message) {
        ...
        Notification n  = new NotificationCompat.Builder(this)
                .setContentTitle("New message recieved")
                .setContentText(""+message.getUserName()+" sent "+message.getUserMessage())
